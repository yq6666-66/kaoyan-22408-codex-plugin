...
`kaoyan-408` 是面向考研 408 方向的中文 Skills-only 学习插件，帮助你在 Codex 和 ChatGPT 中完成真题检索、图文讲解、学习规划、错题复测与多学习层记忆（Obsidian / Notion / Udemy / Sider Scholar / GoodNotes / Exa / Wolfram / A-Z Dictionary / Quizlet / Ace Quiz Maker / Ace Knowledge Graph / AhaMotion / Vocabulary Trainer / Kahoot）。它覆盖数学一、数学二、英语一、英语二和 408，并保留政治辅导。
...
- 多学习层记忆：可选接入 Obsidian Vault、授权 Notion 工作区、Udemy 课程、Sider Scholar/Exa 检索、Wolfram 计算、A-Z Dictionary 词典、Quizlet 闪卡、Ace Quiz Maker 章节测、Ace Knowledge Graph 图谱、AhaMotion 视频、Vocabulary Trainer 词汇与 Kahoot 互动复习；宿主提供对应工具时自动检索并增量写回，未配置或权限不足时自动降级为会话内模式。
...
| `kaoyan-official-info-researcher` | 当年招考、408 院校目录发现、复试与近两年录取核验 |
